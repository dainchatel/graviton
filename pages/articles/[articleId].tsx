import { Layout, ContentGrid, Markdown } from '@/graviton/components'
...
export default function ArticlePage({ article, dropdownLocations, recommendedArticles, recommendedLocations }: PageProps) {
  if (!article) {
    return (
    ...
    <Layout dropdownLocations={dropdownLocations}>
      ...
      </div>
      {
        (recommendedArticles.length > 0 || recommendedLocations.length > 0) ? (
          <div style={{ margin: '2rem auto 0 auto', width: '100%', maxWidth: '832px' }}>
